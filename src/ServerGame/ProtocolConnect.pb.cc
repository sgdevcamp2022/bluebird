...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_ProtocolConnect_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_ProtocolConnect_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_ProtocolConnect_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_ProtocolConnect_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_ProtocolConnect_2eproto = {
  false, false, 107, descriptor_table_protodef_ProtocolConnect_2eproto, "ProtocolConnect.proto", 
  &descriptor_table_ProtocolConnect_2eproto_once, nullptr, 0, 1,
  schemas, file_default_instances, TableStruct_ProtocolConnect_2eproto::offsets,
  file_level_metadata_ProtocolConnect_2eproto, file_level_enum_descriptors_ProtocolConnect_2eproto, file_level_service_descriptors_ProtocolConnect_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_ProtocolConnect_2eproto_getter() {
  return &descriptor_table_ProtocolConnect_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_ProtocolConnect_2eproto(&descriptor_table_ProtocolConnect_2eproto);
namespace Match {
...
::PROTOBUF_NAMESPACE_ID::Metadata Users::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_ProtocolConnect_2eproto_getter, &descriptor_table_ProtocolConnect_2eproto_once,
      file_level_metadata_ProtocolConnect_2eproto[0]);
}
