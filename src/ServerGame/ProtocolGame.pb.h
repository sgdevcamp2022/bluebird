...
#ifndef GOOGLE_PROTOBUF_INCLUDED_ProtocolGame_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_ProtocolGame_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_ProtocolGame_2eproto
...
struct TableStruct_ProtocolGame_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_ProtocolGame_2eproto;
namespace Protocol {
class Data;
...
class Data final :
 ...
 public:
  ...
  public:
  void clear_plyaer();
  ::Protocol::Player* mutable_plyaer(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Protocol::Player >*
      mutable_plyaer();
  private:
  const ::Protocol::Player& _internal_plyaer(int index) const;
  ::Protocol::Player* _internal_add_plyaer();
  public:
  const ::Protocol::Player& plyaer(int index) const;
  ::Protocol::Player* add_plyaer();
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Protocol::Player > plyaer_;
  ...
  friend struct ::TableStruct_ProtocolGame_2eproto;
};
// -------------------------------------------------------------------
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 Data::_internal_matchroom() const {
  return matchroom_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 Data::matchroom() const {
  // @@protoc_insertion_point(field_get:Protocol.Data.matchRoom)
  return _internal_matchroom();
}
inline void Data::_internal_set_matchroom(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  matchroom_ = value;
}
inline void Data::set_matchroom(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _internal_set_matchroom(value);
  // @@protoc_insertion_point(field_set:Protocol.Data.matchRoom)
}

// repeated .Protocol.Player plyaer = 4;
inline int Data::_internal_plyaer_size() const {
  return plyaer_.size();
}
inline int Data::plyaer_size() const {
  return _internal_plyaer_size();
}
inline void Data::clear_plyaer() {
  plyaer_.Clear();
}
inline ::Protocol::Player* Data::mutable_plyaer(int index) {
  // @@protoc_insertion_point(field_mutable:Protocol.Data.plyaer)
  return plyaer_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Protocol::Player >*
Data::mutable_plyaer() {
  // @@protoc_insertion_point(field_mutable_list:Protocol.Data.plyaer)
  return &plyaer_;
}
inline const ::Protocol::Player& Data::_internal_plyaer(int index) const {
  return plyaer_.Get(index);
}
inline const ::Protocol::Player& Data::plyaer(int index) const {
  // @@protoc_insertion_point(field_get:Protocol.Data.plyaer)
  return _internal_plyaer(index);
}
inline ::Protocol::Player* Data::_internal_add_plyaer() {
  return plyaer_.Add();
}
inline ::Protocol::Player* Data::add_plyaer() {
  // @@protoc_insertion_point(field_add:Protocol.Data.plyaer)
  return _internal_add_plyaer();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Protocol::Player >&
Data::plyaer() const {
  // @@protoc_insertion_point(field_list:Protocol.Data.plyaer)
  return plyaer_;
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 Enemy::_internal_id() const {
  return id_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 Enemy::id() const {
  // @@protoc_insertion_point(field_get:Protocol.Enemy.id)
  return _internal_id();
}
inline void Enemy::_internal_set_id(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  id_ = value;
}
inline void Enemy::set_id(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _internal_set_id(value);
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_ProtocolGame_2eproto
